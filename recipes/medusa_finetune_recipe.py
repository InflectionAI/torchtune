...
class FullFinetuneRecipeDistributed(FTRecipeInterface):
    ...
    def _count_params(self, model: MedusaTransformerDecoder) -> None:
        """
        Count and log the number of trainable vs total parameters in the Medusa model.
        
        Args:
            model (MedusaTransformerDecoder): The medusa model to count parameters for
        """
        ...
        utils.log_rank_zero(
            self._logger,
            f"MedusaTransformerDecoder parameter counts: "
